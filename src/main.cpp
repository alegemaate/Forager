...
void loadShaders() {
  defaultShader =
      new GpuProgram("shaders/textured.vert", "shaders/textured.frag");
  waterShader = new GpuProgram("shaders/water.vert", "shaders/water.frag");
  skyShader = new GpuProgram("shaders/sky.vert", "shaders/sky.frag");
}
...
void gameInit() {
  ...
  // Load sky
  theSky = new Skybox();
  theSky->loadSkybox("images/skybox/front.png", "images/skybox/back.png",
